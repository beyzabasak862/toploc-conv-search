...
INDEX_PATH     = "/home/toploc1/Datasets/toploc1/indexes/Snowflake/Flat Search/treccast_flat.index"
IDS_PATH       = "/home/toploc1/Datasets/toploc1/indexes/Snowflake/Flat Search//treccast_flat_ids.npy"

OUTPUT_DIR     = "/home/toploc1/Datasets/toploc1/Exact_Search/Snowflake"
LOG_PATH   = os.path.join(OUTPUT_DIR, "search_flat_snowflake.log")

# Per-dataset inputs. Only the query embeddings + qrels change.
# EDIT the 2020 paths to match your files.
DATASETS = {
    "cast2019": {
        "query_emb": "/home/toploc1/Datasets/conversational/CAST2019/topics/topics_snowflake_embeddings.parquet",
        "qrels":     "/home/toploc1/Datasets/conversational/CAST2019/topics/qrels.qrel",
        
    },
    "cast2020": {
        "query_emb":   "/home/toploc1/Datasets/toploc1/Data Exploration/cast2020_query_embeddings.parquet",
...
def run_dataset(name, cfg):
    ...
    metrics_path = os.path.join(OUTPUT_DIR, f"metrics_flat_snowflake_{name}.json")
