...
OUTPUT_DIR     = "/home/toploc1/Datasets/toploc1/HNSW_paper1/Snowflake/search/results"
...
def output_paths(m):
    return {
        "summary": os.path.join(OUTPUT_DIR, f"snowflake_toplocHNSW_M{m}_ct2019.parquet"),
        "metrics": os.path.join(OUTPUT_DIR, f"snowflake_toplocHNSW_metrics{m}_ct2019.json"),
        "log":     os.path.join(OUTPUT_DIR, f"snowflake_toplocHNSW_M{m}_ct2019.log"),
    }
