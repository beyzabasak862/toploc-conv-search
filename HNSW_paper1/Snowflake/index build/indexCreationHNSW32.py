...
INDEX_PATH      = os.path.join(OUTPUT_DIR, "treccast_hnsw.index")
IDS_PATH        = os.path.join(OUTPUT_DIR, "treccast_hnsw_ids.npy")
CHECKPOINT_PATH = os.path.join(OUTPUT_DIR, "hnsw_checkpoint.json")
LOG_PATH        = os.path.join(OUTPUT_DIR, "indexCreationHNSW.log")
