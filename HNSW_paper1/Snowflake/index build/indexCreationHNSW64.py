...
OUTPUT_DIR = "/home/toploc1/Datasets/toploc1/indexes/HNSW_indexes"

INDEX_PATH      = os.path.join(OUTPUT_DIR, "treccast_hnsw_M64.index")
IDS_PATH        = os.path.join(OUTPUT_DIR, "treccast_hnsw_idsM64.npy")
CHECKPOINT_PATH = os.path.join(OUTPUT_DIR, "hnsw_checkpoint_M64.json")
LOG_PATH        = os.path.join(OUTPUT_DIR, "indexCreationHNSW_M64.log")

M               = 64   # graph connectivity (16–64 typical)
