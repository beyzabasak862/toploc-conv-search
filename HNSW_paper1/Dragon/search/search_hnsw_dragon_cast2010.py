...
QUERY_EMB_PATH = "/home/toploc1/Datasets/toploc1/Data Exploration/topics_dragon_embeddings_2020.parquet"
...
def output_paths(m):
    return {
        "summary": os.path.join(OUTPUT_DIR, f"dragon_toplocHNSW_M{m}_2020.parquet"),
        "metrics": os.path.join(OUTPUT_DIR, f"dragon_toplocHNSW_metrics_M{m}_2020.json"),
        "log":     os.path.join(OUTPUT_DIR, f"dragon_toplocHNSW_M{m}_2020.log"),
    }
